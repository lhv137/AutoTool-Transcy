...
//    CUSTOMIZATION TAB
    ...
    public static final String SWITCHER_DISCLOSURE_BORDER_STYLE = "//span[@class='Polaris-Button__Text'][contains(.,'Thin')]";
    ...
    public static final String SWITCHER_DISCLOSURE_SEARCH_BOX_TEXT_FONT_SETTING = "(//span[contains(@class,'Polaris-Button__Text')])[14]";
    ...
    public static final String SWITCHER_DISCLOSURE_OPTION_FONT_VALUE = "(//input[contains(@autocomplete,'off')])[4]";
    public static final String SWITCHER_DISCLOSURE_OPTION_FONT_SETTING = "(//span[contains(@class,'Polaris-Button__Text')])[15]";
    public static final String SWITCHER_DISCLOSURE_OPTION_FONT_NOTE = "(//span[contains(@class,'Polaris-TextStyle--variationSubdued')])[5]";
   public static final String SWITCHER_DISCLOSURE_SELECT_OPTION_FONT_CONTENT_TITLE = "//span[contains(.,'Selected option font')]";
    public static final String SWITCHER_DISCLOSURE_SELECT_OPTION_FONT_VALUE = "(//input[contains(@autocomplete,'off')])[5]";
    public static final String SWITCHER_DISCLOSURE_SELECT_OPTION_FONT_SETTING = "(//span[contains(@class,'Polaris-Button__Text')])[16]";
    ...
    public static final String SWITCHER_DISCLOSURE_FLAG_STYLE_SETTING = "(//span[contains(@class,'Polaris-Button__Text')])[17]";
    ...
    public static final String COLOR_SCHEME_CONTENT_TITLE = "(//span[contains(.,'Color scheme')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_CONTENT_TITLE = "//h2[contains(.,'Switcher color')]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Background')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_BORDER_CONTENT_TITLE = "(//span[contains(.,'Border')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_BORDER_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_TEXT_CONTENT_TITLE = "(//span[contains(.,'Text')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[3]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_ARROW_CONTENT_TITLE = "(//span[contains(.,'Arrow')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_COLOR_ARROW_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[4]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_CONTENT_TITLE = "//h2[contains(.,'Switcher hover state')]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Background')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[5]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_BORDER_CONTENT_TITLE = "(//span[contains(.,'Border')])[3]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_BORDER_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[6]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_TEXT_CONTENT_TITLE = "(//span[contains(.,'Text')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[7]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_ARROW_CONTENT_TITLE = "(//span[contains(.,'Arrow')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_HOVER_STATE_ARROW_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[8]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_CONTENT_TITLE = "//h2[contains(.,'Switcher active state')]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Background')])[3]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[9]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_BORDER_CONTENT_TITLE = "(//span[contains(.,'Border')])[3]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_BORDER_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[10]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_TEXT_CONTENT_TITLE = "(//span[contains(.,'Text')])[3]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[11]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_ARROW_CONTENT_TITLE = "(//span[contains(.,'Arrow')])[3]";
    public static final String COLOR_SCHEME_SWITCHER_ACTIVE_STATE_ARROW_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[12]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_CONTENT_TITLE = "//h2[contains(.,'Switcher disclosure color')]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Background')])[4]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[13]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BORDER_CONTENT_TITLE = "(//span[contains(.,'Border')])[4]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BORDER_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[14]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_TITLE_COLOR_CONTENT_TITLE = "//span[contains(.,'Title color')]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_TITLE_COLOR_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[15]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Select-box background')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[16]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_BORDER_CONTENT_TITLE = "(//span[contains(.,'Select-box border')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_BORDER_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[17]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_TEXT_CONTENT_TITLE = "(//span[contains(.,'Select-box text')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[18]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_ARROW_CONTENT_TITLE = "(//span[contains(.,'Select-box arrow')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_BOX_ARROW_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[19]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_OPTION_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Option background')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_OPTION_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[20]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_OPTION_TEXT_CONTENT_TITLE = "(//span[contains(.,'Option text')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_OPTION_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[21]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_OPTION_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Selected option background')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_OPTION_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[22]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_OPTION_TEXT_CONTENT_TITLE = "(//span[contains(.,'Selected option text')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SELECT_OPTION_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[23]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SEARCH_BOX_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Search-box background')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SEARCH_BOX_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[24]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SEARCH_BOX_ICON_CONTENT_TITLE = "(//span[contains(.,'Search-box icon')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SEARCH_BOX_ICON_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[25]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SEARCH_BOX_TEXT_CONTENT_TITLE = "(//span[contains(.,'Search-box text')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_SEARCH_BOX_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[26]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BUTTON_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Button background')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BUTTON_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[27]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BUTTON_TEXT_CONTENT_TITLE = "(//span[contains(.,'Button text')])[1]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_COLOR_BUTTON_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[28]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_CONTENT_TITLE = "//h2[contains(.,'Switcher disclosure hover state')]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Select-box background')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[29]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_BORDER_CONTENT_TITLE = "(//span[contains(.,'Select-box border')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_BORDER_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[30]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_TEXT_CONTENT_TITLE = "(//span[contains(.,'Select-box text')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[31]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_ARROW_CONTENT_TITLE = "(//span[contains(.,'Select-box arrow')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_SELECT_BOX_ARROW_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[32]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_OPTION_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Option background')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_OPTION_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[33]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_OPTION_TEXT_CONTENT_TITLE = "(//span[contains(.,'Option text')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_OPTION_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[34]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_BUTTON_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Button background')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_BUTTON_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[35]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_BUTTON_TEXT_CONTENT_TITLE = "(//span[contains(.,'Button text')])[2]";
    public static final String COLOR_SCHEME_SWITCHER_DISCLOSURE_HOVER_STATE_BUTTON_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[36]";
