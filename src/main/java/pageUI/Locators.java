...
//    CUSTOMIZATION TAB
   ...
   public static final String SWITCHER_DISCLOSURE_SELECT_OPTION_FONT_CONTENT_TITLE = "//span[contains(.,'Selected option font')]";
    ...
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_BACKGROUND_CONTENT_TITLE = "(//span[contains(.,'Background')])[1]";
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_BACKGROUND_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[1]";
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_BORDER_CONTENT_TITLE = "(//span[contains(.,'Border')])[2]";
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_BORDER_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[2]";
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_TEXT_CONTENT_TITLE = "(//span[contains(.,'Text')])[1]";
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_TEXT_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[3]";
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_ARROW_CONTENT_TITLE = "(//span[contains(.,'Text')])[1]";
    public static final String COLOR_SCHEMA_SWITCHER_COLOR_ARROW_VALUE_COLOR = "(//div[contains(@class,'sc-f01a64a8-3 epPBNK')])[4]";
